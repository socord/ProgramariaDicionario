function carregaDicionario() {
    var biografia = {
        ...
        bio4: { 
            ...
            image: "img/conceicao-evaristo.png", 
        ...
        bio5: { 
            ...
            image: "img/carolina-de-jesus.png", 
    ...
    for (var bio in biografia){
        content.innerHTML +='<div class = "card">' + '<img src ="' + biografia[bio].image + '"/>'
        +"<details>" + "<summary>" + biografia[bio].nome + "</summary>"+"</details>"+"</div>";
    }
